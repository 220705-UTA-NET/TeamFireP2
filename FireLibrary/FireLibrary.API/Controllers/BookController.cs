...
namespace FireLibrary.API.Controllers
{
    ...
    public class BookController : ControllerBase
    {
        ...
        public async Task<ActionResult<Book>> GetBookAsync(string isbn)
        {
            ...
            Book book1 = new Book("1785034677", "The Martian", "Ebury Publishing", "English", 171, "So you want to lieve on Mars. Perhaps its the rugged terrain, beutiful scenery, or vast..", 1234, "AuthorName", "Six days ago, astronaut Mark Watney became one of the fist people to walk on Mars", "Excerpt", 5, 5);
            Book book2 = new Book("441569595", "Neuromancer", "Ace", "English", 271,  "Case was the sharpest data-thief in the matrix--until he crossed the wrong people and they crippled his nervious system, banishing him from cyberspace. Now a mysterious new employer has recruited himfor a last-chance run at an unthinkably powerful art...", 54321, "William Gibson", "The sky above the port was the color of televison, tuned to a dead channel. \"It's not like I'm Using,\" Case heard someone say, as he shouldered his way through the crowd around the door of the Chat.", "Excerpt", 5, 5);
            string json = "";
